...
{
    UIBarButtonItem* rigthBtn = [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemAdd target:self action:@selector(addDaily)];
...
#pragma mark - ❀==============❂ 导航栏动画 ❂==============❀
-(void)addDaily{
    AddDailyVC* daily = [AddDailyVC new];
